...
similar_users=find_similar_users(2,USER_WEIGHTS_PATH,USER2USER_ENCODED,USER2USER_DECODED)
pref = get_user_preferences(2,RATING_DF,DF)
print(get_user_recommendations(similar_users,pref,DF,SYNOPSIS_DF,RATING_DF))

print(hybrid_recommendation(2))